...
class Options():
	...
	def initialize(self):
		...
		parser.add_argument('--av_size', type=int, default=0, help="set 0 if you do not need attr_vec")
		parser.add_argument('--z_size', type=int, default=32, help="noise vector")

		parser.add_argument('--rep_size', type=int, default=64, help="hidden vector")
		parser.add_argument('--d_size', type=int, default=32, help="d vector")
		parser.add_argument('--gc_size', type=int, default=64, help="gc vector")
		...
		parser.add_argument('--beta', type=int, default=0.9, help='beta')
